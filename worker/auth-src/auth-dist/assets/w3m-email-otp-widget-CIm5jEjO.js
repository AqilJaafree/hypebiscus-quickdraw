import{$ as e,C as t,ai as n,c as r,ci as i,d as a,f as o,ft as s,l as c,m as l,o as u,tt as d,v as f}from"./index-DHzoh2pq.js";import{o as p,s as m}from"./wui-text-Bo1u6ozV.js";import"./wui-loading-spinner-C4ayLskb.js";import"./wui-link-DKgf8xSc.js";var h=o`
  :host {
    position: relative;
...
`,g=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},_=class extends l{constructor(){super(...arguments),this.disabled=!1,this.value=``}render(){return f`<input
      type="number"
      maxlength="1"
      inputmode="numeric"
      autofocus
      ...
      value=${this.value}
    /> `}};_.styles=[a,c,h],g([m({type:Boolean})],_.prototype,`disabled`,void 0),g([m({type:String})],_.prototype,`value`,void 0),_=g([u(`wui-input-numeric`)],_);var v=t`
  :host {
    position: relative;
    display: block;
  }
...
`,S=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},C,w=C=class extends l{firstUpdated(){this.startOTPTimeout()}disconnectedCallback(){clearTimeout(this.OTPTimeout)}constructor(){super(),this.loading=!1,this.timeoutTimeLeft=n.getTimeToNextEmailLogin(),this.error=``,this.otp=``,this.email=d.state.data?.email,this.authConnector=e.getAuthConnector()}render(){if(!this.email)throw Error(`w3m-email-otp-widget: No email provided`);let e=!!this.timeoutTimeLeft,t=this.getFooterLabels(e);return f`
      <wui-flex
    ...
    `}startOTPTimeout(){this.timeoutTimeLeft=n.getTimeToNextEmailLogin(),this.OTPTimeout=setInterval(()=>{this.timeoutTimeLeft>0?this.timeoutTimeLeft=n.getTimeToNextEmailLogin():clearInterval(this.OTPTimeout)},1e3)}async onOtpInputChange(e){try{this.loading||(this.otp=e.detail,this.shouldSubmitOnOtpChange()&&(this.loading=!0,await this.onOtpSubmit?.(this.otp)))}catch(e){this.error=i.parseError(e),this.loading=!1}}async onResendCode(){try{if(this.onOtpResend){if(!this.loading&&!this.timeoutTimeLeft){if(this.error=``,this.otp=``,!e.getAuthConnector()||!this.email)throw Error(`w3m-email-otp-widget: Unable to resend email`);this.loading=!0,await this.onOtpResend(this.email),this.startOTPTimeout(),s.showSuccess(`Code email resent`)}}else this.onStartOver&&this.onStartOver()}catch(e){s.showError(e)}finally{this.loading=!1}}getFooterLabels(e){return this.onStartOver?{title:`Something wrong?`,action:`Try again ${e?`in ${this.timeoutTimeLeft}s`:``}`}:{title:`Didn't receive it?`,action:`Resend ${e?`in ${this.timeoutTimeLeft}s`:`Code`}`}}shouldSubmitOnOtpChange(){return this.authConnector&&this.otp.length===C.OTP_LENGTH}};w.OTP_LENGTH=6,w.styles=x,S([p()],w.prototype,`loading`,void 0),S([p()],w.prototype,`timeoutTimeLeft`,void 0),S([p()],w.prototype,`error`,void 0),w=C=S([u(`w3m-email-otp-widget`)],w);export{w as t};
import{at as e,d as t,f as n,l as r,m as i,o as a,tt as o,v as s}from"./index-DHzoh2pq.js";import{o as c,s as l}from"./wui-text-Bo1u6ozV.js";import{t as u}from"./if-defined-Q1zLy4s7.js";import"./wui-wallet-switch-DftLtEsF.js";import"./wui-icon-box-DldBjuNQ.js";import{t as d}from"./HelpersUtil-BQ0wF88u.js";import"./w3m-onramp-providers-footer-hBkb4pIE.js";var f=n`
  :host {
    display: block;
  }
...
`,p=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},m=class extends i{constructor(){super(...arguments),this.resizeObserver=void 0,this.unsubscribe=[],this.status=`hide`,this.view=o.state.view}firstUpdated(){this.status=d.hasFooter()?`show`:`hide`,this.unsubscribe.push(o.subscribeKey(`view`,e=>{this.view=e,this.status=d.hasFooter()?`show`:`hide`,this.status===`hide`&&document.documentElement.style.setProperty(`--apkt-footer-height`,`0px`)})),this.resizeObserver=new ResizeObserver(e=>{for(let t of e)if(t.target===this.getWrapper()){let e=`${t.contentRect.height}px`;document.documentElement.style.setProperty(`--apkt-footer-height`,e)}}),this.resizeObserver.observe(this.getWrapper())}render(){return s`
      <div class="container" status=${this.status}>${this.templatePageContainer()}</div>
    `}templatePageContainer(){return d.hasFooter()?s` ${this.templateFooter()}`:null}templateFooter(){switch(this.view){case`Networks`:return this.templateNetworksFooter();case`Connect`:case`ConnectWallets`:case`OnRampFiatSelect`:case`OnRampTokenSelect`:return s`<w3m-legal-footer></w3m-legal-footer>`;case`OnRampProviders`:return s`<w3m-onramp-providers-footer></w3m-onramp-providers-footer>`;default:return null}}templateNetworksFooter(){return s` <wui-flex
      class="footer-in"
      padding="3"
...
`,y=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},b=4,x=class extends i{constructor(){super(...arguments),this.walletImages=[]}render(){let e=this.walletImages.length<b;return s`${this.walletImages.slice(0,b).map(({src:e,walletName:t})=>s`
          <wui-wallet-image
            size="sm"
            imageSrc=${e}
            name=${u(t)}
          ></wui-wallet-image>
        `)}
    ${e?[...Array(b-this.walletImages.length)].map(()=>s` <wui-wallet-image size="sm" name=""></wui-wallet-image>`):null} `}};x.styles=[t,v],y([l({type:Array})],x.prototype,`walletImages`,void 0),x=y([a(`wui-all-wallets-image`)],x);var S=n`
  :host {
    width: 100%;
  }
...
`,C=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},w={eip155:`ethereum`,solana:`solana`,bip122:`bitcoin`,polkadot:void 0,cosmos:void 0,sui:void 0,stacks:void 0,ton:`ton`,tron:`tron`},T=class extends i{constructor(){super(...arguments),this.walletImages=[],this.imageSrc=``,this.name=``,this.size=`md`,this.tabIdx=void 0,this.namespaces=[],this.disabled=!1,this.showAllWallets=!1,this.loading=!1,this.loadingSpinnerColor=`accent-100`}render(){return this.dataset.size=this.size,s`
      <button
    ...
    `}templateNamespaces(){return this.namespaces?.length?s`<wui-flex alignItems="center" gap="0">
        ${this.namespaces.map((e,t)=>s`<wui-flex
              alignItems="center"
        ...
        name=${this.name}
      ></wui-wallet-image>`:!this.showAllWallets&&!this.imageSrc?s`<wui-wallet-image size="sm" name=${this.name}></wui-wallet-image>`:null}templateStatus(){return this.loading?s`<wui-loading-spinner size="lg" color="accent-primary"></wui-loading-spinner>`:this.tagLabel&&this.tagVariant?s`<wui-tag size="sm" variant=${this.tagVariant}>${this.tagLabel}</wui-tag>`:null}};T.styles=[t,r,S],C([l({type:Array})],T.prototype,`walletImages`,void 0),C([l()],T.prototype,`imageSrc`,void 0),C([l()],T.prototype,`name`,void 0),C([l()],T.prototype,`size`,void 0),C([l()],T.prototype,`tagLabel`,void 0),C([l()],T.prototype,`tagVariant`,void 0),C([l()],T.prototype,`walletIcon`,void 0),C([l()],T.prototype,`tabIdx`,void 0),C([l({type:Array})],T.prototype,`namespaces`,void 0),C([l({type:Boolean})],T.prototype,`disabled`,void 0),C([l({type:Boolean})],T.prototype,`showAllWallets`,void 0),C([l({type:Boolean})],T.prototype,`loading`,void 0),C([l({type:String})],T.prototype,`loadingSpinnerColor`,void 0),T=C([a(`wui-list-wallet`)],T);export{m as n,_ as t};